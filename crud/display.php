...
<button class="btn btn-primary my-5"><a href="user.php" class="text-light">Adauga un antagonist</a>
</button>
...
<table class="table">
  <thead>
    <tr class="text-light">
      <th scope="col">Nume antagonist</th>
      <th scope="col">Caracterul antagonistului</th>
...
?>
    ...
    <div class="container"></div>
<button class="btn btn-primary my-5"><a href="../crud_eroi/user.php" class="text-light">Adauga un erou!</a>
</button>
...
if($result){
    while($row=mysqli_fetch_assoc($result)){ 
      ...
      <td>
       <button class="btn btn-primary"><a href="../crud_eroi/update.php?updateid='.$id.' " class="text-light">Actualizare</a></button>
       <button class="btn btn-danger"><a href="../crud_eroi/delete.php?deleteid='.$id.' " class="text-light">Sterge</a></button>
      </td>
    </tr>';
    }
}
